...
/* Includes ------------------------------------------------------------------------------ */
#include "../Inc/lib_pcdHeader/lib_iso15693pcd.h"
#include "drv_95HF.h"
...
static int8_t ISO15693_ExtendedReadSingleBlock (const uint8_t Flags, const uint8_t *UIDin, const uint16_t BlockNumber,uint8_t *pResponse );
...
static int8_t ISO15693_ExtendedReadMultipleBlock (const uint8_t Flags, const uint8_t *UIDin, const uint16_t BlockNumber, uint16_t NbBlock, uint8_t *pResponse );
...
* @retval ISO15693_ERRORCODE_DEFAULT : an error occured
*/
int8_t ISO15693_ExtendedGetSystemInfo ( const uint8_t Flags, const uint8_t Parameters, const uint8_t *UIDin, uint8_t *pResponse)
{
...
* @retval 	ERRORCODE_GENERIC	: 	 PCD  returns an error code
*/
int8_t ISO15693_ExtendedLockSingleBlock ( const uint8_t Flags, const uint8_t *UIDin, uint16_t BlockNumber,uint8_t *pResponse)
{
...
* @retval 	ERRORCODE_GENERIC	: 	 PCD  returns an error code
*/
int8_t ISO15693_ExtendedGetMultipleBlockSecutityStatus (const uint8_t Flags, const uint8_t *UIDin, uint16_t BlockNumber, uint16_t NbBlocks,uint8_t *pResponse)
{
